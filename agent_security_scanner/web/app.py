"""
FastAPI application factory for the Agent Security Scanner web dashboard.
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Web dashboard API for the Agent Security Scanner",
        version="0.2.0",
        lifespan=lifespan,
    )

    # CORS — allow frontend dev server (configurable via ASS_CORS_ORIGINS env var)
